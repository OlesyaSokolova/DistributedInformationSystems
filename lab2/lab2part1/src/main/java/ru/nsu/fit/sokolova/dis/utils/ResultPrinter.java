...
public class ResultPrinter {
    ...
    public ResultPrinter(XMLProcessor processor) {
        this.processor = processor;
    }
    public void printUsersChangesets() {
        Map<String, Map<String, Integer>> result = processor.getStat();
        ...
        result.entrySet().stream()
                ...
                /*Количество правок внесенных каждым пользователем (пользователь –
    ...
    public void printNumberOfAllProcessedNodes() {
        System.out.println("Read elememts: " + processor.getReadElementsCounter() + " of " + processor.getLimit());
    }
